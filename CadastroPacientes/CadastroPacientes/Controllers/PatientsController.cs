...
namespace PatientRegistration.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,DateOfBirth,CPF,PhoneNumber,Email")] Patients patients)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,DateOfBirth,CPF,PhoneNumber,Email")] Patients patients)
        {
            if (id != patients.Id)
            {
                return NotFound();
